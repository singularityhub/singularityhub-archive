...
branch: "master"
tag: "idi38"
commit: "f8d46a7d2821ee45ade9a7c132325bc340ad6ac6"
version: "fa44c2df3207776445cb1e6301d56686e366a7d508b44553ba4b067484641257"
build_date: "2021-01-20T00:39:13.838Z"
size_mb: 3884.29296875
size: 4072976384
sif: "https://datasets.datalad.org/shub/fzimmermann89/Singularity/idi38/2021-01-20-f8d46a7d-fa44c2df/fa44c2df3207776445cb1e6301d56686e366a7d508b44553ba4b067484641257.sif"
datalad_url: https://datasets.datalad.org?dir=/shub/fzimmermann89/Singularity/idi38/2021-01-20-f8d46a7d-fa44c2df/
recipe: https://datasets.datalad.org/shub/fzimmermann89/Singularity/idi38/2021-01-20-f8d46a7d-fa44c2df/Singularity
...
```bash
$ singularity pull shub://fzimmermann89/Singularity:idi38
```
...
conda activate
conda install -q -y conda "numexpr>=2.7.2" "numpy>=1.17" hdf5 scipy "jedi=0.17" numba mkl cython  "jupyterlab=2.2"  jupyter scikit-image appdirs mako scikit-learn "python>=3.8" seaborn pandas line_profiler black ninja colorama memory_profiler isort mkl-devel fastrlock six setuptools
conda install -q -y -c  conda-forge -c plotly "h5py>3" lmfit ipympl pathos "nodejs>=14"  ptvsd xeus-python pytools nbdime "pip>=20.1" jupyter-dash ipyvolume jupyter-server-proxy six openssl
conda clean -a -y &
