---
id: 6694
name: "ertheisen/southkaibab_centos"
branch: "master"
tag: "hg19v1.centos"
commit: "84e7561f8a97e8839d641c23b6f96258084adebb"
version: "320c014848a51f8a7d590d3d627094b2"
build_date: "2019-03-01T19:49:13.176Z"
size_mb: 10747
size: 3998711839
...
```bash
$ singularity pull shub://ertheisen/southkaibab_centos:hg19v1.centos
```
...
Singularity container containing following apps for ChIP-seq and CUT&RUN processing.
 ...
 bowtie2_alignment_chip: Alignment pipeline using default sensitivity and mapping parameters in bowtie2, assumes trimmed fastqs, sensitive end-to-end alignment, overlap allowed, default insert from 10-500 bp, assumes single end can work with >= 75 bp reads
...
%post
	...
	mv /bowtie2_alignment_chip.py /appscripts/
...
%apprun bowtie2_alignment_chip
	python /appscripts/bowtie2_alignment_chip.py
...
## Collection
 ...
 - Name: [ertheisen/southkaibab_centos](https://github.com/ertheisen/southkaibab_centos)
 - License: None
