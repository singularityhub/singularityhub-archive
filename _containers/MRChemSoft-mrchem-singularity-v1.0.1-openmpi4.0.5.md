...
branch: "master"
tag: "v1.0.1-openmpi4.0.5"
commit: "5b3d73d576f10fe9d8791aa8df89041a6c53f5f7"
version: "8343f771dcf91637ff05a9fdbae508e7cc5d6c13d20227e902823cd9db2a9b10"
build_date: "2021-04-16T13:08:13.309Z"
size_mb: 117.84375
size: 123568128
sif: "https://datasets.datalad.org/shub/MRChemSoft/mrchem-singularity/v1.0.1-openmpi4.0.5/2021-04-16-5b3d73d5-8343f771/8343f771dcf91637ff05a9fdbae508e7cc5d6c13d20227e902823cd9db2a9b10.sif"
datalad_url: https://datasets.datalad.org?dir=/shub/MRChemSoft/mrchem-singularity/v1.0.1-openmpi4.0.5/2021-04-16-5b3d73d5-8343f771/
recipe: https://datasets.datalad.org/shub/MRChemSoft/mrchem-singularity/v1.0.1-openmpi4.0.5/2021-04-16-5b3d73d5-8343f771/Singularity
...
```bash
$ singularity pull shub://MRChemSoft/mrchem-singularity:v1.0.1-openmpi4.0.5
```
...
# http://github.com/MRChemSoft/mrchem/archive/v1.0.1.tar.gz
%post
    cd /
    mkdir -p /var/tmp && wget -q -nc --no-check-certificate -P /var/tmp http://github.com/MRChemSoft/mrchem/archive/v1.0.1.tar.gz
    mkdir -p /var/tmp && tar -x -f /var/tmp/v1.0.1.tar.gz -C /var/tmp -z
    mkdir -p /var/tmp/mrchem-1.0.1/build && cd /var/tmp/mrchem-1.0.1/build && cmake -DCMAKE_INSTALL_PREFIX=/usr/local/mrchem -D CMAKE_BUILD_TYPE=Release -D ENABLE_MPI=ON -D ENABLE_OPENMP=ON -D ENABLE_ARCH_FLAGS=OFF -D CXX_COMPILER=mpicxx /var/tmp/mrchem-1.0.1
    cmake --build /var/tmp/mrchem-1.0.1/build --target all -- -j$(nproc)
    cmake --build /var/tmp/mrchem-1.0.1/build --target install -- -j$(nproc)
    rm -rf /var/tmp/mrchem-1.0.1 /var/tmp/v1.0.1.tar.gz
