...
version: "36cf884cf0236d75f9a8d1f441a36e00"
build_date: "2018-01-08T16:00:00.866Z"
size_mb: 4720
size: 1421881375
sif: "https://datasets.datalad.org/shub/sequana/sequana/0_6_1/2018-01-08-98a45ee6-36cf884c/36cf884cf0236d75f9a8d1f441a36e00.simg"
datalad_url: https://datasets.datalad.org?dir=/shub/sequana/sequana/0_6_1/2018-01-08-98a45ee6-36cf884c/
recipe: https://datasets.datalad.org/shub/sequana/sequana/0_6_1/2018-01-08-98a45ee6-36cf884c/Singularity
...
```bash
$ singularity pull shub://sequana/sequana:0_6_1
```
...
%post
    ...
    # equivalent to requirements_pipelines.txt version 0.6.0
    conda install -y bcftools bedtools bleach bowtie bowtie2 bwa
    conda install -y cutadapt dsrc fastq-screen fastqc==0.11.5
    conda install -y freebayes khmer
    conda install -y kraken krona multiqc
    conda install -y picard pigz samtools shustring star subread
    conda install -y snpeff spades sambamba
