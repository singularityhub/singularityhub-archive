---
id: 9571
name: "Delaunay/training-container"
branch: "master"
tag: "rocm"
commit: "3bdc580d023f071bbd879fc77040e87564da19b4"
version: "c73544372d0893482046af13b6ee665d"
build_date: "2019-06-06T16:11:53.886Z"
size_mb: 13985
size: 3586936863
...
```bash
$ singularity pull shub://Delaunay/training-container:rocm
```
...
%post
    ...
    pip install --no-deps mkl-fft
    pip install --no-deps mkl-random
    ...
    pip install --no-deps opencv-python==4.0.0.21
    ...
    rm /usr/bin/python3 && rm /usr/bin/python && ln -s /usr/bin/python3.6 /usr/bin/python && ln -s /usr/bin/python3.6 /usr/bin/python3
```

## Collection

 - Name: [Delaunay/training-container](https://github.com/Delaunay/training-container)
 - License: None
