...
branch: "master"
tag: "test"
commit: "f43c0f00a5d8e709e2d0e8e46151392120e9b222"
version: "48d5dcbb133fdb126b3e04768758fd4ad75a3218bf5a440b05d5a6a68b2b1076"
build_date: "2021-01-24T22:50:22.348Z"
size_mb: 4104.3984375
size: 4303773696
sif: "https://datasets.datalad.org/shub/fzimmermann89/idi/test/2021-01-24-f43c0f00-48d5dcbb/48d5dcbb133fdb126b3e04768758fd4ad75a3218bf5a440b05d5a6a68b2b1076.sif"
datalad_url: https://datasets.datalad.org?dir=/shub/fzimmermann89/idi/test/2021-01-24-f43c0f00-48d5dcbb/
recipe: https://datasets.datalad.org/shub/fzimmermann89/idi/test/2021-01-24-f43c0f00-48d5dcbb/Singularity
...
```bash
$ singularity pull shub://fzimmermann89/idi:test
```
...
conda activate
conda install -q -y -c conda-forge -c zimmf mamba conda "cudatoolkit=*.*_fake"

mamba install -q -y affine astropy bokeh bottleneck chainer click  configargparse cvxopt dask dask-ml decorator distributed joblib mako mock munch natsort  plotly  pytest pywavelets scikit-learn scikit-image shapely snakeviz sortedcollections xarray openpyxl  simplejson colorama   protobuf requests "numexpr>=2.7.2" "numpy>=1.17" scipy "jedi=0.17" numba mkl cython  "jupyterlab=2.2"  jupyter scikit-image appdirs mako scikit-learn "python>=3.8" seaborn pandas line_profiler black ninja colorama memory_profiler isort mkl-devel fastrlock six setuptools affine astropy bokeh bottleneck chainer click  configargparse cvxopt dask dask-ml decorator distributed joblib mako mock munch natsort  plotly  pytest pywavelets scikit-learn scikit-image shapely snakeviz sortedcollections xarray openpyxl  

mamba install -q -y -c anaconda -c  conda-forge -c plotly -c pytorch gpustat colorful "h5py>3" lmfit ipympl pathos "nodejs>=14"  ptvsd xeus-python pytools nbdime "pip>=20.1" jupyter-dash ipyvolume jupyter-server-proxy six openssl "jedi<0.18" jax chainer pytorch torchvision torchaudio pytables
...
pip install -q --upgrade jupyterlab-git "jupyterlab_code_formatter<1.4"  jupyterlab_latex jupyter-dash "jupyterlab<3" jupyterlab_hdf "jedi<0.18"
